...
var game = new _partials_Game__WEBPACK_IMPORTED_MODULE_1__["default"]('game', 512, 256); //numbers are w and h 
...
!(function webpackMissingModule() { var e = new Error("Cannot find module './Paddle'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
function () {
  function Game(element, width, height) {
    ...
    this.boardGap = 10; //player 1

    this.player1 = new (function webpackMissingModule() { var e = new Error("Cannot find module './Paddle'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(this.height, this.paddleWidth, this.boardGap, (this.height - this.paddleHeight) / 2, this.paddleHeight, _settings__WEBPACK_IMPORTED_MODULE_0__["KEYS"].a, _settings__WEBPACK_IMPORTED_MODULE_0__["KEYS"].z); //player 2

    this.player2 = new (function webpackMissingModule() { var e = new Error("Cannot find module './Paddle'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(this.height, this.paddleWidth, this.paddleHeight, this.width - this.boardGap - this.paddleWidth, (this.height - this.paddleHeight) / 2, _settings__WEBPACK_IMPORTED_MODULE_0__["KEYS"].up, _settings__WEBPACK_IMPORTED_MODULE_0__["KEYS"].down);
  }
